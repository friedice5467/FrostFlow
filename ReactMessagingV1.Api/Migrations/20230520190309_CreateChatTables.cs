    ...
    public partial class CreateChatTables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChatSessionUsers", x => new { x.SessionId, x.UserId });
                    table.ForeignKey(
                        name: "FK_ChatSessionUsers_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ChatSessionUsers_ChatSessions_SessionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChatSessionUsers_UserId",
